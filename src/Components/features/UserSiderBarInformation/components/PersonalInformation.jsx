  ...
  return (
    <div className='personal'>
        <div className='base-info  p-2 my-2 rounded-2 text-center'>
              <div>
                  <img src="/imgs/97a2a402-03eb-4c4d-a24f-90671890f297.jpg" className='rounded-circle' style={{border:'3px solid #eeee'}} width={140} height={140}  />
              </div>
              ...
              <div className="footer my-2 py-2 d-flex justify-content-center gap-2 border-bottom">
                  <a href='https://t.me/Alifront2026'><span><FaTelegram color='orange' size={20}/></span></a>
                 <a href="https://instagram.com/Alifront2026"> <span><FaInstagramSquare color='orange' size={20}/></span></a>
